...
Compare biosolids concentrations to adult farmer ADDs for each LAU scenario and each biosolids concentration scenario. Make plots and run linear regression (on a log10-log10 scale).
